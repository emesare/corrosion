...
function(_add_cargo_build out_cargo_build_out_dir)
    ...
    message(DEBUG "TARGET ${target_name_cmake} produces byproducts ${build_byproducts}")
...
* **BIN_NAMESPACE**: If specified, prefixes the CMake target corresponding to all binary crates with `<namespace>::`.
                     This allows binary and library crates to have the same name.
* **LIB_NAMESPACE**: If specified, prefixes the CMake target corresponding to all library crates with `<namespace>::`.
                     This allows binary and library crates to have the same name.
